package com.srchaven.siwa.errorhandling.model;
...
{
    private static final String DETAILS_START = "**************************ERROR DETAILS START**************************";

    private static final String SEPARATOR = "------------------------";

    private static final String DETAILS_STOP = "**************************ERROR DETAILS STOP**************************";
